                ...
                <p> <a style="background-color: #20B2AA;"  class="btn btn-success" href="<?php echo base_url() ?>information_animals"> BACK</a> 
                 <a style="background-color: #20B2AA;" class="btn btn-success" href="<?php echo base_url() ?> vaccine_register"> Create New Vaccines </a> </p>
                            ...
                            <?php
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td ><a class="btn btn-info" href="<?php echo base_url() ?>users/editVaccine/<?php echo $item->cod_vacuna ?>">Edit</a></td>

                                    <td><a class="btn btn-danger eliminar_vaccine" href="<?php echo base_url() ?>Users/eliminarVaccine/<?php echo $item->cod_vacuna ?>"> Eliminar </a> </td>
                                  </tr>
                                <?php
                                }
                                ?>                                
                    ...
                    <script type="text/javascript">
                        $(".eliminar_vaccine").each(function() {
