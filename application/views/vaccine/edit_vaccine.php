          ...
          <div style="text-align: center;">
            <form style="padding:5px; cursor:pointer;   width:300px; margin: 10px 10px 10px 10px; text-align:left;" action="" method="post">
                  ...
                  <?php foreach ($vaccine as $item) {?>
                      ...
                      <input type="text" class="form-control" name="cod_vacuna" placeholder="COD VACCINE" required="" value="<?php echo $item->cod_vacuna; ?>">
                    ...
                    <div class="form-group">
                      <input  style="background-color: #20B2AA;" type="submit" class="btn btn-success" name="SumitVaccineEdit" value="Guardar" />
                        <a class="btn btn-danger" href="<?php echo base_url() ?>vaccine"> Cancelar </a>
                    </div>
                    <?php } ?>
        </form>
        </div>
