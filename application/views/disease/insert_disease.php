  ...
  <div  class="panel-heading">
      ...
      <div class="col-lg-5 col-lg-offset-2">
          ...
          <div style="text-align: center;">
            <form style="padding:5px; cursor:pointer;   width:300px; margin: 10px 10px 10px 10px; text-align:left;" action="<?php echo base_url() ?>insertDisease/<?php ?>" method="post">

                      <div class="form-group valid-form">
                      <input type="text" class="form-control" name="cod_enfermedad" placeholder="COD DISEASE" required="" value="">
                      <?php echo form_error('cod_enfermedad','<span class="help-block">','</span>'); ?>
                    </div>
                    ...
                    <div class="form-group">
                      <input  style="background-color: #20B2AA;" type="submit" class="btn btn-success" name="SumitDisease" value="Guardar" />
                        <a class="btn btn-danger" href="<?php echo base_url() ?>disease"> Cancelar </a>
                    </div>
        </form>
        </div>
           </div>
