          ...
          <div style="text-align: center;">
            <form style="padding:5px; cursor:pointer;   width:300px; margin: 10px 10px 10px 10px; text-align:left;" action="" method="post">
                  ...
                  <?php foreach ($disease as $item) {?>
                      ...
                      <input type="text" class="form-control" name="cod_enfermedad" placeholder="COD VACCINE" required="" value="<?php echo $item->cod_enfermedad; ?>">
                    ...
                    <div class="form-group">
                      <input  style="background-color: #20B2AA;" type="submit" class="btn btn-success" name="SumitDiseaseEdit" value="Guardar" />
