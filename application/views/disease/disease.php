        ...
        <h1> LIST DISEASE </h1>
                ...
                <p> <a class="btn btn-success" href="<?php echo base_url() ?> disease_register"> Create New Disease </a> </p>
                            ...
                            <?php
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td ><a class="btn btn-info" href="<?php echo base_url() ?>users/editDisease/<?php echo $item->cod_enfermedad ?>">Edit</a></td>

                                    <td><a class="btn btn-danger eliminar_disease" href="<?php echo base_url() ?>Users/eliminarDisease/<?php echo $item->cod_enfermedad ?>"> Eliminar </a> </td>
                                  </tr>
                                <?php
                                }
                                ?>                                
                    ...
                    <script type="text/javascript">
                        $(".eliminar_disease").each(function() {
