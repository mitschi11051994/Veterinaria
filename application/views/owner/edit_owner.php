          ...
          <div style="text-align: center;">
            <form style="padding:5px; cursor:pointer;   width:300px; margin: 10px 10px 10px 10px; text-align:left;" action="" method="post">
                  ...
                  <?php foreach ($owner as $item) {?>
                    ...
                    <div class="form-group valid-form">
                      <input type="text" class="form-control" name="nombre" placeholder="NAME" required="" value="<?php echo $item->nombre; ?>">
                      <?php echo form_error('nombre','<span class="help-block">','</span>'); ?>
                    </div>

                    <div class="form-group valid-form">
                      <input type="text" class="form-control" name="primer_apellido" placeholder="FIRST NAME" required="" value="<?php echo $item->primer_apellido; ?>">
                      <?php echo form_error('primer_apellido','<span class="help-block">','</span>'); ?>
                    </div>

                    <div class="form-group valid-form">
                      <input type="text" class="form-control" name="segundo_apellido" placeholder="LAST NAME" required="" value="<?php echo $item->segundo_apellido; ?>">
                      <?php echo form_error('segundo_apellido','<span class="help-block">','</span>'); ?>
                    </div>

                    <div class="form-group valid-form">
                      <input type="text" class="form-control" name="telefono" placeholder="TEL" required="" value="<?php echo $item->telefono; ?>">
                      <?php echo form_error('telefono','<span class="help-block">','</span>'); ?>
                    </div>

                    <div class="form-group valid-form">
                      <input type="text" class="form-control" name="direccion" placeholder="ADDRESS" required="" value="<?php echo $item->direccion; ?>">
                      <?php echo form_error('direccion','<span class="help-block">','</span>'); ?>
                    </div>

                    <div class="form-group">
                      <input  style="background-color: #20B2AA;" type="submit" class="btn btn-success" name="editOwnerSumit" value="Guardar" />
