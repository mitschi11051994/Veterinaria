...
<head>
  ...
  <title>Insert Pet Vaccine Disease </title>
  ...
  <div  class="panel-heading">
      ...
      <div class="col-lg-5 col-lg-offset-2">
          ...
          <div style="text-align: center;">
            <form style="padding:5px; cursor:pointer;   width:300px; margin: 10px 10px 10px 10px; text-align:left;" action="<?php echo base_url() ?>insertPet_vacuna_enfermedad/<?php ?>" method="post">
                      ...
                      <div class="form-group valid-form">
                        <input type="date" class="form-control" name="fecha_aplicacion" placeholder="APLICATION DATE" required="" value="" required>
