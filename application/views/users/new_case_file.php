...
<div  class="container">
  ...
  <div  class="panel-heading" style="width: 52em; height: 12em;">
      ...
      <div class="form-group">
              <a href="<?php echo base_url(); ?>Users/owner"> <input style="background-color: #20B2AA;" type="button" name="Crud_user_animal" type="submit" value="Owner" class="btn btn-primary btn-lg btn-block"></input></a>
            </div>
            <div class="form-group">
              <a href="<?php echo base_url(); ?>users/pet "> <input style="background-color: #20B2AA;" type="button" name="Crud_user_animal" type="submit" value="Mascot " class="btn btn-primary btn-lg btn-block"></input></a>
            </div> 

      <div class="form-group">
              <a href="<?php echo base_url(); ?>users/account"> <input style="background-color: #20B2AA;" type="button" name="Crud_user_animal" type="submit" value="Back" class="btn btn-primary btn-lg btn-block"></input></a>
            </div>
