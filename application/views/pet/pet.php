      ...
      <div class="panel-body" style="width: 50em; margin-left: 0em; margin-top: 4em;  padding: 5px 10px;"> 
        ...
        <h1> PET FILE </h1>
                <p> <a class="btn btn-success" href="<?php echo base_url() ?>new_case_file"> BACK</a> 
                 ...
                 <a class="btn btn-success" href="<?php echo base_url() ?>new_case_file"> Consult Disease</a>
                 <a class="btn btn-success" href="<?php echo base_url() ?>new_case_file"> Consult Vaccine</a>  
