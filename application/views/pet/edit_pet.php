            ...
            <form style="padding:5px; cursor:pointer;   width:300px; margin: 10px 10px 10px 10px; text-align:left;" action="" method="post">
                  ...
                  <?php foreach ($pet as $item) {?>
                      ...
                      <div class="form-group valid-form">
                        <input type="text" class="form-control" name="cod_mascota" placeholder="COD PET" required="" value="<?php echo $item->cod_mascota; ?>">
                    ...
                    <div class="form-group valid-form">
                      <input type="text" class="form-control" name="nombre" placeholder="NOM" required="" value="<?php echo $item->nombre; ?>">
                      <?php echo form_error('nombre','<span class="help-block">','</span>'); ?>
                    </div>

                    <div class="form-group valid-form">
                      <input type="date" class="form-control" name="fecha_nacimiento" placeholder="BIRTH DATE" required="" value="<?php echo $item->fecha_nacimiento; ?>">
                      <?php echo form_error('fecha_nacimiento','<span class="help-block">','</span>'); ?>
                    </div>


                    <div class="form-group valid-form">                      
                      <select  id="combobox_race" name="combobox_race" class="form-control">
                    ...
                    <div class="form-group">
                      <input  style="background-color: #20B2AA;" type="submit" class="btn btn-success" name="SumitPetEdit" value="Guardar" />
