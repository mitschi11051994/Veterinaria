...
<head>
  ...
  <title>Insert Vaccine Disease</title>
      ...
      <div class="col-lg-5 col-lg-offset-2">
          ...
          <div style="text-align: center;">
            <form style="padding:5px; cursor:pointer;   width:300px; margin: 10px 10px 10px 10px; text-align:left;" action="<?php echo base_url() ?>insertVaccine_disease/<?php ?>" method="post">
                      ...
                      <select  id="combobox_disease" name="combobox_disease" class="form-control" required="Need select a new Disease code">
                      ...
                      <select  id="combobox_vaccine" name="combobox_vaccine" class="form-control" required="Need select a new Vaccine code">
                    ...
                    <div class="form-group valid-form">
                      <input type="text" class="form-control" name="porcentaje_efectividad" placeholder="PERCENTAGE EFFECTIVENESS" required="" value="">
                      <?php echo form_error('porcentaje_efectividad','<span class="help-block">','</span>'); ?>
                    </div>

                    <div class="form-group valid-form">
                      <input type="text" class="form-control" name="notas" placeholder="NOTES" required="" value="">
                      <?php echo form_error('notas','<span class="help-block">','</span>'); ?>
                    </div>

                    <div class="form-group">
                      <input  style="background-color: #20B2AA;" type="submit" class="btn btn-success" name="SumitVaccine_disease" value="Guardar" />
