...
<div  class="container">
  <div  class="row">
  <div class="panel panel-success" style="width: 57em; height: 30em; margin-left: 13em; padding: 2em; margin-top: 5em; margin-top: 1em;" >
  ...
  <div  class="panel-heading">
      ...
      <div class="col-lg-5 col-lg-offset-2">
          ...
          <div style="text-align: center;">
            <form style="padding:5px; cursor:pointer;   width:300px; margin: 10px 10px 10px 10px; text-align:left;" action="<?php echo base_url() ?>insertSpecies/<?php ?>" method="post">

                      <div class="form-group valid-form">
                      <input type="text" class="form-control" name="cod_especie" placeholder="COD SPECIES" required="" value="">
                    ...
                    <div class="form-group">
                      <input  style="background-color: #20B2AA;" type="submit" class="btn btn-success" name="SumitSpecies" value="Guardar" />
