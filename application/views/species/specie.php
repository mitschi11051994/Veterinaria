        ...
        <h1> LIST SPECIES </h1>
                ...
                <a class="btn btn-success" href="<?php echo base_url() ?> species_register"> Create New Species </a> </p>
                            ...
                            <?php
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td ><a class="btn btn-info" href="<?php echo base_url() ?>users/editSpecie/<?php echo $item->cod_especie ?>">Edit</a></td>

                                    <td><a class="btn btn-danger eliminar_species" href="<?php echo base_url() ?>Users/eliminarSpecies/<?php echo $item->cod_especie ?>"> Eliminar </a> </td>
                                  </tr>
                                <?php
                                }
                                ?>                                
                    ...
                    <script type="text/javascript">
                        $(".eliminar_species").each(function() {
                            var href = $(this).attr('href');
                            $(this).attr('href', 'javascript:void(0)');
                            $(this).click(function() {
                                if (confirm("¿Seguro desea eliminar este especie?")) {
                                    location.href = href;
                                }
                            });
                        });
