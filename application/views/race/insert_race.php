  ...
  <div  class="panel-heading">
      ...
      <div class="col-lg-5 col-lg-offset-2">
          ...
          <div style="text-align: center;">
            <form style="padding:5px; cursor:pointer;   width:300px; margin: 10px 10px 10px 10px; text-align:left;" action="<?php echo base_url() ?>insertRace/<?php ?>" method="post">

                      <div class="form-group valid-form">
                      <input type="text" class="form-control" name="cod_raza" placeholder="COD RACE" required="" value="">
                      <?php echo form_error('cod_raza','<span class="help-block">','</span>'); ?>
                    </div>
                    ...
                    <div class="form-group valid-form">                      
                      <select  id="combobox" name="combobox" class="form-control">
                          <?php foreach($species as $each){ ?>
                              <option  value="<?php echo $each->cod_especie; ?>"><?php echo $each->cod_especie; ?></option>';
                          <?php } ?>
                      </select>
                    </div>
                    ...
                    <div class="form-group">
                      <input  style="background-color: #20B2AA;" type="submit" class="btn btn-success" name="SumitRace" value="Guardar" />
